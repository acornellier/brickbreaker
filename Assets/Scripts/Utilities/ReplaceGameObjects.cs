...
namespace CommonsEditor
{
    public class ReplaceGameObjects : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            replacingObject =
                EditorGUILayout.ObjectField(replacingObject, typeof(GameObject), true)
                as GameObject;
        ...
        void ReplaceSelected()
        {
            if (replacingObject != null)
            {
                ...
                foreach (Transform t in Selection.transforms)
                {
                    ...
                    if (
                        PrefabUtility.GetPrefabInstanceStatus(replacingObject)
                    ...
                    else if (AssetDatabase.Contains(replacingObject))
                    {
                        ...
                        o = (GameObject)PrefabUtility.InstantiatePrefab(
                            replacingObject,
                            t.gameObject.scene
                        );
                    }
